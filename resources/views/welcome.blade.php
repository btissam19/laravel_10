...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="">
        <div class="relative flex justify-center items-center  bg-gray-700">
            ...
            @if (Route::has('login'))
                <div class="sm:fixed sm:top-0 sm:right-0 p-5 text-right min-w-full bg-gray-700">
                    @auth
                    ...
                    @else
                    <a href="{{url('/blogs')}}" class="font-semibold text-gray-100  dark:text-gray-400  focus:outline focus:outline-2 focus:rounded-sm focus:outline-gray-700">Blog</a>
